...
class CreateFirstCell: UITableViewCell {
    ...
    var viewModel =  MeetingViewModel(model: Meeting(id: "", owner: SimpleUser(id: "", email: "", image: ""), createdTime: 0, subject: "", location: "", notes: "", image: "", singleMeeting: false, hiddenMeeting: false, deadlineMeeting: false, participants: nil, numOfParticipants: nil, deadlineTag: nil))
