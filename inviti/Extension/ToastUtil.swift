...
open class ToastUtil {
    ...
    static private let defaultMidBgColor = UIColor.hexStringToUIColor(hex: "0xE8E8E8")
    ...
    private static func addToastLabel(message: String) {
        ...
        toastLabel.setAnchorCenterVerticallyTo(view: toastView,
                                               heightAnchor: defaultMidHeight,
                                               leadingAnchor: (toastView.leadingAnchor, defaultLabelSidesPadding),
                                               trailingAnchor: (toastView.trailingAnchor, -defaultLabelSidesPadding))
    }
}
